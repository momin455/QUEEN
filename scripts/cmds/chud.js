module.exports = {
  ...
  onStart: async function ({ api, event, userData, args }) {
    ...
    if(!mention) return api.sendMessage("👉 মমিন বস যাকে চুদ্দে চাউ তার আইডি @ম্যানশন দাও__//🖕🥵", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = []; 
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
setTimeout(() => {a({body: "কিরে মাদারচোত মমিন বস এর চুদন খাওয়ায় জন্য রেডি তো?" + "লে চুদা খা মাঙ্গের বেটা 😂😂" + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "মমিন বস এর চুদন কেমন লাগলো বাচ্চা 🤣🤣🤣🤣??" + " " + name, mentions: arraytag})} , 84000);
  }
};
