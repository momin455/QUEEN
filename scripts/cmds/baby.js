        ...
        onChat: async function ({ api, event, commandName }) {
                ...
                if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
                        ...
                        const randomReplies = [
                                ...
                                "𝗡𝗮𝘄 𝗔𝗺𝗮𝗿 𝗕𝗼𝘀𝘀 𝗞 𝗠𝗲𝗮𝘀𝘀𝗮𝗴𝗲 𝗗𝗮𝘄 https://www.facebook.com/profile.php?id=61587947897924",
                                ...
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, momin, momin ও তো করতে পারো😑?",
                                ...
                                "কথা দেও আমাকে পটাবা...!! 😌",
                                "বার বার Disturb করেছিস কোনো, আমার জানু momin এর সাথে ব্যাস্ত আসি 😋",
